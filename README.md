...
### Historical Data
Due to time constraints, I have decided to limit the historical data to the last 5 years' data for each city proposed in the challenge (Ottawa, Toronto, Vancouver). Historical data will be useful to determine seasons' related statistical data (mean, median, standard deviation, and others), as well as a more precise, month-related statistical data. 
...
Finally, if historically the coldest temperature for summer has been 23º C, and a reading in summer comes as 22º, this breaks a historical local minimum, which can be considered an event. 
